...
"""
	This program solves a IVP EDO using Modded Euler's method.
"""

def modded_euler_method(f, a, b, y_0, h, y_val):
	...
	for i in range(it_num):
		...
		f_1=re_sub_x.sub(str(x_val), f)
		f_1=re_sub_y.sub(str(y_i), f_1)
		k_1=ro.r(f_1)[0]

		f_2=re_sub_x.sub(str(x_val + h), f)
		f_2=re_sub_y.sub(str(y_i + h*k_1), f_2)
		k_2=ro.r(f_2)[0]
...
if __name__ == "__main__":
	...
	res=modded_euler_method(f, a, b, y_0, h, y_val)
